function selectLotteryWinnersDefault(randomBits, numParticipants, numWinners, allowMultipleWins)
{
...
function selectLotteryWinnersWeighted(randomBits, numParticipants, numWinners)
{
	// code from http://stackoverflow.com/questions/5199901/how-to-sort-an-associative-array-by-its-values-in-javascript
	var tuples = [];
	var indexHash = 0;
...
var defaultLotteryScript = '' + selectLotteryWinnersWeighted + ' selectLotteryWinnersWeighted(randomBits, numParticipants, numWinners);';
